            ...
            <div class="product-list__product-row product-list__header-table">
                ...
                <div class="product-list__cols-sizes">
                    <div class="product-list__cols-sizes-10">
                        <div class="m-0 p-0">
                            <input type="number" step="0.01" min="0" class="form-control ${SMART_FIELDS.LINEAR_METER_PIECES} product_list__fontstyle" placeholder="" data-field="${SMART_FIELDS.LINEAR_METER_PIECES}" value="${this.data[SMART_FIELDS.LINEAR_METER_PIECES]}">
                        </div>
                    </div>
                    <div class="product-list__cols-sizes-11">
                        <div class="m-0 p-0">
                            <input type="number" step="0.01" min="0" class="form-control ${SMART_FIELDS.SQUARE_METER_PIECES} product_list__fontstyle" placeholder="" data-field="${SMART_FIELDS.SQUARE_METER_PIECES}" value="${this.data[SMART_FIELDS.SQUARE_METER_PIECES]}">
                        </div>
                    </div>
                    <div class="product-list__cols-sizes-20">
                        <div class="m-0 p-0">
                            <input type="number" step="0.01" min="0" class="form-control ${SMART_FIELDS.LINEAR_METER_TOTAL} product_list__fontstyle" placeholder="" data-field="${SMART_FIELDS.LINEAR_METER_TOTAL}" value="${this.data[SMART_FIELDS.LINEAR_METER_TOTAL]}">
                        </div>
                    </div>
                    <div class="product-list__cols-sizes-21">
                        <div class="m-0 p-0">
                            <input type="number" step="0.01" min="0" class="form-control ${SMART_FIELDS.SQUARE_METER_TOTAL} product_list__fontstyle" placeholder="" data-field="${SMART_FIELDS.SQUARE_METER_TOTAL}" value="${this.data[SMART_FIELDS.SQUARE_METER_TOTAL]}">
                        </div>
                    </div>
                </div>
