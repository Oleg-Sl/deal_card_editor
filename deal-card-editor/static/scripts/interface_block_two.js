...
export class InterfaceBlockTwo {
    ...
    render(fields, data) {
        ...
        contentHTML += this.getSelectHTML(fields.UF_CRM_1640199620.items, data.UF_CRM_1640199620, "UF_CRM_1640199620", "Печать <br>согласно ЦП?", 1);
        // !!! Неизвестно поле !!!
    ...
    getSelectHTML(itemsSelects, itemKey, titleEng, titleRus, widthCols) {
        ...
        let contentHTML = `
            <div class="col-${widthCols}" id="${titleEng}">
                <label for="taskeditor__${titleEng}" class="text-truncate" style="width: 100%;">${titleRus}</label>
