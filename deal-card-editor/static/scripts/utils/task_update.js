...
function getDataTable(products, itemsdManufactTechn, itemsFilmWidth) {
    let tbody = `[TR]
        ...
        [TD][B]Длина, м[/B][/TD]
        [TD][B]Высота, м[/B][/TD]
        [TD][B]Кол-во бортов[/B][/TD]
        [TD][B]Кол-во авто[/B][/TD]
        [TD][B]Кв.м. монтажа[/B][/TD]
        [TD][B][/B]Ссылка на исходники клиента[/TD]
    ...
    for (let product of products) {
        tbody += `[TR]
            ...
            [TD]${getValueByKey(LIST_LAMINATIONS[product[SMART_FIELDS.WIDTH_FILM]] || [], product[SMART_FIELDS.LAMINATION])}[/TD]
            [TD]${getValueByKey(LIST_WIDTH_FILMS[product[SMART_FIELDS.WIDTH_FILM]] || [], product[SMART_FIELDS.FILM])}[/TD]
            [TD]${product[SMART_FIELDS.LINEAR_METER] || ""}[/TD]
            [TD]${product[SMART_FIELDS.LENGTH_AREA] || ""}[/TD]
            [TD]${product[SMART_FIELDS.HEIGHT_AREA] || ""}[/TD]
            [TD]${getValueByKey(LIST_COUNT_SIDES, product[SMART_FIELDS.COUNT_SIDE])}[/TD]
